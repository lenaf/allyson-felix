...
export default function Synopsis() {
  return (
    ...
    <Section id='synopsis' className="prose px-4 sm:px-8 md:px-12 py-12" >
      ...
      <p>
        This longitudinal film, featuring never-before-seen archival footage gathered over the course of 35 years, delves deep into Allyson’s career and personal story, her family, her drive, her charm, her joy and her beliefs.      </p>
      <p>
