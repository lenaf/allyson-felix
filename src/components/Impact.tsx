      ...
      <div className="md:grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <Resource
            ...
            description={
              <p>
                OKBEI works tirelessly to equip families to have healthy births with dignity and reduce health disparities among pregnant women—so that all of Oklahoma can grow together.              </p>
            } />
          ...
          <Resource
            ...
            description={
              <p>
                The number one “Yelp-like” platform for the pregnancy and new motherhood journey, made by and for people of color.              </p>
            } />
        </div>
      </div>
