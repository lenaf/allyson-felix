...
export default function Credits() {
  return (
    ...
    <Section id='credits' className="prose px-4 sm:px-8 md:px-12 py-12">
      ...
      <div>
        <p className="">{`Founded in 1972, Downtown Community Television Center, Inc. (DCTV) has grown into one of the leading documentary production and film education centers in the country. A community of and for documentary filmmakers, DCTV is a unique space where community screenings, master classes, youth education programs and affordable production resources all exist side by side with award-winning documentary work. DCTV\u2019s film and television productions have been recognized with three Academy Award Nominations, 18 National Emmy Awards, five duPont-Columbia Awards, a Peabody Award, 6 New York Emmy Awards and accolades at film festivals and competitions around the world. Recent work includes The Last Twins, coming soon to PBS, She Runs the World, a 2025 Tribeca Festival official selection, the Oscar-nominated Armed Only With A Camera (HBO), the duPont-Columbia Award-winning Can\u2019t Look Away (Bloomberg Originals), Surveilled (HBO), the news and documentary series Axios on HBO (HBO), the Oscar shortlisted Shut up and Paint (PBS) about the artist Titus Kaphar, the six-part documentary series On Pointe (Disney+) about the NYC Ballet, the decades-spanning Cuba and the Cameraman (Netflix), Life on Parole (PBS - FRONTLINE), Alternate Endings: Six New Ways to Die in America (HBO), Finding the Way Home (HBO), and the documentary series 15: A Quincea\u00f1era Story (HBO). In 2022, DCTV opened a new documentary-only cinema FIREHOUSE in its landmark firehouse home in Manhattan\u2019s Chinatown.`}
        </p>
      </div>
