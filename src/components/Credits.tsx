...
export default function Credits() {
  return (
    ...
    <Section id='credits' className="prose px-4 sm:px-8 md:px-12 py-12">
      ...
      <div className="mb-2">
        <h3 className="uppercase">Perri Peltz</h3>
      ...
      <div className="mb-2">
        <h3 className="uppercase">MATTHEW O’NEILL</h3>
        <div className="uppercase">DIRECTOR / PRODUCER</div>
      ...
      <div className="mb-2">
        <h3 className="uppercase">TONYA LEWIS LEE</h3>
      ...
      <div className="mb-2">
        <h3 className="uppercase">LISA BINNS</h3>
      ...
      <div className="mb-2">
        <h3 className="uppercase">JULIA ROSENHEIM</h3>
      ...
      <div className="mb-2">
        <h3 className="uppercase">FRANCES HENDERSON</h3>
      ...
      <div className="mb-2">
        <h3 className="uppercase">NASREEN ALKHATEEB</h3>
