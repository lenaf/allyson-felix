...
export default function Credits() {
  return (
    ...
    <Section id='credits' className="prose px-4 sm:px-8 md:px-12 py-12">
      ...
      <div className="mb-2">
        <h3 className="uppercase text-primary">Perri Peltz</h3>
        <div className="uppercase">Director/Producer</div>
      ...
      <div className="mb-2">
        <h3 className="uppercase text-primary">MATTHEW O’NEILL</h3>
        <div className="uppercase">DIRECTOR / PRODUCER</div>
      ...
      <div className="mb-2">
        <h3 className="uppercase text-primary">TONYA LEWIS LEE</h3>
        <div className="uppercase">EXECUTIVE PRODUCER </div>
      ...
      <div className="mb-2">
        <h3 className="uppercase text-primary">LISA BINNS</h3>
        <div className="uppercase">PRODUCER</div>
      ...
      <div className="mb-2">
        <h3 className="uppercase text-primary">JULIA ROSENHEIM</h3>
        <div className="uppercase">CO-PRODUCER</div>
      ...
      <div className="mb-2">
        <h3 className="uppercase text-primary">FRANCES HENDERSON</h3>
        <div className="uppercase">EDITOR</div>
      ...
      <div className="mb-2">
        <h3 className="uppercase text-primary">NASREEN ALKHATEEB</h3>
