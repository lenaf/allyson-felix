...
const Description = ({ children }) => <span className="ml-1 text-gray-400 text-sm">{children}</span>
...
export default function Credits() {
  return (
    ...
    <Section id='credits' className="prose p-4 sm:p-8 md:p-12">
      ...
      <h4 className="text-gray-300 uppercase">About the Filmakers</h4>
